import 'package:pertemuan_9/models/item.dart';
...
class HomePage extends StatelessWidget {
  final List<Item> items = [
    Item(
        name: 'Gula', price: 10000, image: 'gula.jpeg', stock: 100, rating: 4.5),
    Item(
    ...
    Item(
        ...
        stock: 10,
        rating: 4.8),
    Item(name: 'Kopi', price: 1000, image: 'kopi.jpeg', stock: 5, rating: 4.9),
  ];
